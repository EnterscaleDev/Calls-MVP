...
const ACTION_LABELS: Record<string, string> = {
  ...
  campaign_completed: "Campaign marked completed",
  ...
  agent_invite_resent: "Invitation resent",
  agent_invite_revoked: "Invitation revoked",
  agent_invite_accepted: "Invitation accepted",
